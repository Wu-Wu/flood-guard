...
Индикатор располагается в месте коммутации датчиков и кранов (скорее всего туалетная комната) и служит для визуализации состояния приводов кранов (предполагаемое состояние) чтобы исключить необходимость хождения к электрощиту, где располагаются основные индикаторы состояния.
